/**
 * Pure PNG decoding utilities — shared between the server, build scripts,
...
/**
 * Decode a single character PNG (112x96) into direction-keyed frame arrays.
...
/**
 * Decode a single floor tile PNG (16x16 grayscale pattern).
 */
